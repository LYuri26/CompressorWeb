        ...
        <head>
            ...
            <style>
                ...
                .credits-container {
                    ...
                    box-shadow: 0 0 8px rgba(0, 0, 0, 0.1); /* Adiciona uma sombra ao container */
                ...
                .btn-link {
                    ...
                    padding: 10px 15px; /* Adiciona padding ao botão */
                ...
                .btn-link-voltar {
                    ...
                    color: #ffffff; /* Define a cor do texto do botão */
                    padding: 10px 20px; /* Adiciona padding ao botão de voltar */
